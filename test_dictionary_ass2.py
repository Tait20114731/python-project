...
#importing functions from list_assesment2
from dictionary_ass2 import add_value, delete_value, sort_dict, binary_search_dict
...
class TestDictionaryAss2(unittest.TestCase):
    ...
    def test_delete_value_nonexistent_key(self):
        test_dict = {'Key1': 'Value1'}
        result = delete_value(test_dict, 'Key2')
    ...
    def test_sort_dict_invalid_order(self):
        ...
        with self.assertRaises(ValueError):
            sort_dict(test_dict, 'invalid_order')
    ...
    def test_binary_search_dict_found(self):
        ...
        result = binary_search_dict(test_dict, 'bravo')
    ...
    def test_binary_search_dict_not_found(self):
        test_dict = {'alpha': 'A', 'bravo': 'B', 'charlie': 'C'}
        result = binary_search_dict(test_dict, 'delta')
